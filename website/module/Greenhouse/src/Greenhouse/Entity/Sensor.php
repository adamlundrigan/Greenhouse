...
class Sensor
{
    ...
    public function setLatestReading(SensorReading $r) { $this->latest_reading = $r; return $this; }
    public function getLatestReading() { return $this->latest_reading; }
}
